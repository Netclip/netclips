...
class CommentResourceIT {
    ...
    void putNewComment() throws Exception {
        ...
        updatedComment.timeStamp(UPDATED_TIME_STAMP).content(UPDATED_CONTENT).likes(UPDATED_LIKES).dislikes(UPDATED_DISLIKES);
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.timeStamp(UPDATED_TIME_STAMP).likes(UPDATED_LIKES).dislikes(UPDATED_DISLIKES);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.timeStamp(UPDATED_TIME_STAMP).content(UPDATED_CONTENT).likes(UPDATED_LIKES).dislikes(UPDATED_DISLIKES);
