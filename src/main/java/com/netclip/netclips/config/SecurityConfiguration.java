...
import com.netclip.netclips.security.*;
import com.netclip.netclips.security.jwt.*;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("api/video-previews/**").permitAll()
            ...
            .antMatchers("/api/s3/**").hasAuthority(AuthoritiesConstants.ADMIN)
